...
protected:
	...
	virtual void calculateDirectionalMoveset(bool directions[9], bool calculatedMoveset[8][8]) const; // Helper function, same as Queen's moveset if use all 8 Directions except Center.
};
